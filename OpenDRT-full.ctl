...
// @ART-param: ["tn_Lg", "Display Grey Luminance", 2, 25, 10, 0.1]
// @ART-param: ["tn_con", "Contrast", 1.0, 2.0, 1.66, 0.01]
// @ART-param: ["tn_sh", "Shoulder Clip", 0.0, 1.0, 0.5, 0.01]
// @ART-param: ["tn_toe", "Toe", 0.0, 0.1, 0.003, 0.001]
// @ART-param: ["tn_off", "Offset", 0.0, 0.02, 0.005, 0.0001]
// @ART-param: ["tn_hcon_enable", "Enable", false, "Contrast High"]
// @ART-param: ["tn_hcon", "Value", -1.0, 1.0, 0.0, 0.01, "Contrast High"]
// @ART-param: ["tn_hcon_pv", "Pivot", 0.0, 4.0, 1.0, 0.01, "Contrast High"]
// @ART-param: ["tn_hcon_st", "Strength", 0.0, 4.0, 4.0, 0.01, "Contrast High"]
// @ART-param: ["tn_lcon_enable", "Enable", false, "Contrast Low"]
// @ART-param: ["tn_lcon", "Value", 0.0, 3.0, 0.0, 0.01, "Contrast Low"]
// @ART-param: ["tn_lcon_w", "Width", 0.0, 2.0, 0.5, 0.01, "Contrast Low"]
// @ART-param: ["cwp", "Temperature", ["D93", "D75", "D65", "D60", "D55", "D50"], 2, "Creative White"]
// @ART-param: ["cwp_lm", "Limit", 0.0, 1.0, 0.25, 0.01, "Creative White"]
// @ART-param: ["rs_sa", "Strength", 0.0, 0.6, 0.35, 0.001, "Render Space"]
// @ART-param: ["rs_rw", "Weight R", 0.0, 0.8, 0.25, 0.001, "Render Space"]
// @ART-param: ["rs_bw", "Weight B", 0.0, 0.8, 0.55, 0.001, "Render Space"]
// @ART-param: ["pt_enable", "Enable", true, "Purity Compress"]
// @ART-param: ["pt_lml", "Limit Low", 0.0, 1.0, 0.25, 0.01, "Purity Compress"]
// @ART-param: ["pt_lml_r", "Limit Low R", 0.0, 1.0, 0.5, 0.01, "Purity Compress"]
// @ART-param: ["pt_lml_g", "Limit Low G", 0.0, 1.0, 0.0, 0.01, "Purity Compress"]
// @ART-param: ["pt_lml_b", "Limit Low B", 0.0, 1.0, 0.1, 0.01, "Purity Compress"]
// @ART-param: ["pt_lmh", "Limit High", 0.0, 1.0, 0.25, 0.01, "Purity Compress"]
// @ART-param: ["pt_lmh_r", "Limit High R", 0.0, 1.0, 0.5, 0.01, "Purity Compress"]
// @ART-param: ["pt_lmh_b", "Limit High B", 0.0, 1.0, 0.0, 0.01, "Purity Compress"]
// @ART-param: ["ptl_enable", "Enable", true, "Purity Softclip"]
// @ART-param: ["ptl_c", "C", 0.0, 0.25, 0.06, 0.001, "Purity Softclip"]
// @ART-param: ["ptl_m", "M", 0.0, 0.25, 0.08, 0.001, "Purity Softclip"]
// @ART-param: ["ptl_y", "Y", 0.0, 0.25, 0.06, 0.001, "Purity Softclip"]
// @ART-param: ["ptm_enable", "Enable", true, "Mid Purity"]
// @ART-param: ["ptm_low", "Low", 0.0, 2.0, 0.5, 0.02, "Mid Purity"]
// @ART-param: ["ptm_low_rng", "Low Range", 0.0, 1.0, 0.25, 0.01, "Mid Purity"]
// @ART-param: ["ptm_low_st", "Low Strength", 0.1, 1.0, 0.5, 0.01, "Mid Purity"]
// @ART-param: ["ptm_high", "High", -0.9, 0.0, -0.8, 0.01, "Mid Purity"]
// @ART-param: ["ptm_high_rng", "High Range", 0.0, 1.0, 0.3, 0.01, "Mid Purity"]
// @ART-param: ["ptm_high_st", "High Strength", 0.1, 1.0, 0.4, 0.01, "Mid Purity"]
// @ART-param: ["brl_enable", "Enable", true, "Brilliance"]
// @ART-param: ["brl", "Value", -6.0, 2.0, 0.0, 0.01, "Brilliance"]
// @ART-param: ["brl_r", "R", -6.0, 2.0, -2.5, 0.01, "Brilliance"]
// @ART-param: ["brl_g", "G", -6.0, 2.0, -1.5, 0.01, "Brilliance"]
// @ART-param: ["brl_b", "B", -6.0, 2.0, -1.5, 0.01, "Brilliance"]
// @ART-param: ["brl_rng", "Range", 0.0, 1.0, 0.5, 0.01, "Brilliance"]
// @ART-param: ["brl_st", "Strength", 0.0, 1.0, 0.35, 0.01, "Brilliance"]
// @ART-param: ["brlp_enable", "Enable", true, "Post Brilliance"]
// @ART-param: ["brlp", "Value", -1.0, 0.0, -0.5, 0.01, "Post Brilliance"]
// @ART-param: ["brlp_r", "R", -3.0, 0.0, -1.25, 0.01, "Post Brilliance"]
// @ART-param: ["brlp_g", "G", -3.0, 0.0, -1.25, 0.01, "Post Brilliance"]
// @ART-param: ["brlp_b", "B", -3.0, 0.0, -0.25, 0.01, "Post Brilliance"]
// @ART-param: ["hc_enable", "Enable", true, "Hue Contrast"]
// @ART-param: ["hc_r", "R", 0.0, 2.0, 1.0, 0.01, "Hue Contrast"]
// @ART-param: ["hc_r_rng", "R Range", 0.0, 1.0, 0.3, 0.01, "Hue Contrast"]
// @ART-param: ["hs_rgb_enable", "Enable", true, "Hueshift RGB"]
// @ART-param: ["hs_r", "R", 0.0, 1.0, 0.6, 0.01, "Hueshift RGB"]
// @ART-param: ["hs_r_rng", "R Range", 0.0, 2.0, 0.7, 0.01, "Hueshift RGB"]
// @ART-param: ["hs_g", "G", 0.0, 1.0, 0.35, 0.01, "Hueshift RGB"]
// @ART-param: ["hs_g_rng", "G Range", 0.0, 2.0, 1.0, 0.01, "Hueshift RGB"]
// @ART-param: ["hs_b", "B", 0.0, 1.0, 0.66, 0.01, "Hueshift RGB"]
// @ART-param: ["hs_b_rng", "B Range", 0.0, 2.0, 1.0, 0.01, "Hueshift RGB"]
// @ART-param: ["hs_cmy_enable", "Enable", true, "Hueshift CMY"]
// @ART-param: ["hs_c", "C", 0.0, 1.0, 0.25, 0.01, "Hueshift CMY"]
// @ART-param: ["hs_c_rng", "C Range", 0.0, 1.0, 1.0, 0.01, "Hueshift CMY"]
// @ART-param: ["hs_m", "M", 0.0, 1.0, 0.0, 0.01, "Hueshift CMY"]
// @ART-param: ["hs_m_rng", "M Range", 0.0, 1.0, 1.0, 0.01, "Hueshift CMY"]
// @ART-param: ["hs_y", "Y", 0.0, 1.0, 0.0, 0.01, "Hueshift CMY"]
// @ART-param: ["hs_y_rng", "Y Range", 0.0, 1.0, 1.0, 0.01, "Hueshift CMY"]

// @ART-param: ["tn_su", "Surround", ["Dark", "Dim", "Bright"], 1]
// @ART-param: ["display_gamut", "Display gamut", ["Rec.709", "P3 D65", "Rec.2020"]]

// @ART-preset: ["look_standard", "Look - Standard", { "tn_con" : 1.66, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.005, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : false, "tn_lcon" : 0.0, "tn_lcon_w" : 0.5, "cwp" : 2, "cwp_lm" : 0.25, "rs_sa" : 0.35, "rs_rw" : 0.25, "rs_bw" : 0.55, "pt_enable" : true, "pt_lml" : 0.25, "pt_lml_r" : 0.5, "pt_lml_g" : 0.0, "pt_lml_b" : 0.1, "pt_lmh" : 0.25, "pt_lmh_r" : 0.5, "pt_lmh_b" : 0.0, "ptl_enable" : true, "ptl_c" : 0.06, "ptl_m" : 0.08, "ptl_y" : 0.06, "ptm_enable" : true, "ptm_low" : 0.5, "ptm_low_rng" : 0.25, "ptm_low_st" : 0.5, "ptm_high" : -0.8, "ptm_high_rng" : 0.3, "ptm_high_st" : 0.4, "brl_enable" : true, "brl" : 0.0, "brl_r" : -2.5, "brl_g" : -1.5, "brl_b" : -1.5, "brl_rng" : 0.5, "brl_st" : 0.35, "brlp_enable" : true, "brlp" : -0.5, "brlp_r" : -1.25, "brlp_g" : -1.25, "brlp_b" : -0.25, "hc_enable" : true, "hc_r" : 1.0, "hc_r_rng" : 0.3, "hs_rgb_enable" : true, "hs_r" : 0.6, "hs_r_rng" : 0.7, "hs_g" : 0.35, "hs_g_rng" : 1.0, "hs_b" : 0.66, "hs_b_rng" : 1.0, "hs_cmy_enable" : true, "hs_c" : 0.25, "hs_c_rng" : 1.0, "hs_m" : 0.0, "hs_m_rng" : 1.0, "hs_y" : 0.0, "hs_y_rng" : 1.0 }]
// 
// @ART-preset: ["look_arriba", "Look - Arriba", { "tn_con" : 1.05, "tn_sh" : 0.5, "tn_toe" : 0.1, "tn_off" : 0.01, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 1.5, "tn_lcon_w" : 0.2, "cwp" : 2, "cwp_lm" : 0.25, "rs_sa" : 0.35, "rs_rw" : 0.25, "rs_bw" : 0.55, "pt_enable" : true, "pt_lml" : 0.25, "pt_lml_r" : 0.45, "pt_lml_g" : 0.0, "pt_lml_b" : 0.1, "pt_lmh" : 0.25, "pt_lmh_r" : 0.25, "pt_lmh_b" : 0.0, "ptl_enable" : true, "ptl_c" : 0.06, "ptl_m" : 0.08, "ptl_y" : 0.06, "ptm_enable" : true, "ptm_low" : 1.0, "ptm_low_rng" : 0.4, "ptm_low_st" : 0.5, "ptm_high" : -0.8, "ptm_high_rng" : 0.66, "ptm_high_st" : 0.6, "brl_enable" : true, "brl" : 0.0, "brl_r" : -2.5, "brl_g" : -1.5, "brl_b" : -1.5, "brl_rng" : 0.5, "brl_st" : 0.35, "brlp_enable" : true, "brlp" : 0.0, "brlp_r" : -1.7, "brlp_g" : -2.0, "brlp_b" : -0.5, "hc_enable" : true, "hc_r" : 1.0, "hc_r_rng" : 0.3, "hs_rgb_enable" : true, "hs_r" : 0.6, "hs_r_rng" : 0.8, "hs_g" : 0.35, "hs_g_rng" : 1.0, "hs_b" : 0.66, "hs_b_rng" : 1.0, "hs_cmy_enable" : true, "hs_c" : 0.15, "hs_c_rng" : 1.0, "hs_m" : 0.0, "hs_m_rng" : 1.0, "hs_y" : 0.0, "hs_y_rng" : 1.0 } ]
// 
// @ART-preset: ["look_sylvan", "Look - Sylvan", { "tn_con" : 1.6, "tn_sh" : 0.5, "tn_toe" : 0.01, "tn_off" : 0.01, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 0.25, "tn_lcon_w" : 0.75, "cwp" : 2, "cwp_lm" : 0.25, "rs_sa" : 0.25, "rs_rw" : 0.25, "rs_bw" : 0.55, "pt_enable" : true, "pt_lml" : 0.15, "pt_lml_r" : 0.5, "pt_lml_g" : 0.15, "pt_lml_b" : 0.1, "pt_lmh" : 0.25, "pt_lmh_r" : 0.15, "pt_lmh_b" : 0.15, "ptl_enable" : true, "ptl_c" : 0.05, "ptl_m" : 0.08, "ptl_y" : 0.05, "ptm_enable" : true, "ptm_low" : 0.5, "ptm_low_rng" : 0.5, "ptm_low_st" : 0.5, "ptm_high" : -0.8, "ptm_high_rng" : 0.5, "ptm_high_st" : 0.5, "brl_enable" : true, "brl" : -1.0, "brl_r" : -2.0, "brl_g" : -2.0, "brl_b" : 0.0, "brl_rng" : 0.25, "brl_st" : 0.25, "brlp_enable" : true, "brlp" : -1.0, "brlp_r" : -0.5, "brlp_g" : -0.25, "brlp_b" : -0.25, "hc_enable" : true, "hc_r" : 1.0, "hc_r_rng" : 0.4, "hs_rgb_enable" : true, "hs_r" : 0.6, "hs_r_rng" : 1.15, "hs_g" : 0.8, "hs_g_rng" : 1.25, "hs_b" : 0.6, "hs_b_rng" : 1.0, "hs_cmy_enable" : true, "hs_c" : 0.25, "hs_c_rng" : 0.25, "hs_m" : 0.25, "hs_m_rng" : 0.5, "hs_y" : 0.35, "hs_y_rng" : 0.5 }]
// 
// @ART-preset: ["look_colorful", "Look - Colorful", { "tn_con" : 1.5, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.003, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 0.4, "tn_lcon_w" : 0.5, "cwp" : 2, "cwp_lm" : 0.25, "rs_sa" : 0.35, "rs_rw" : 0.25, "rs_bw" : 0.55, "pt_enable" : true, "pt_lml" : 0.5, "pt_lml_r" : 1.0, "pt_lml_g" : 0.0, "pt_lml_b" : 0.5, "pt_lmh" : 0.25, "pt_lmh_r" : 0.25, "pt_lmh_b" : 0.15, "ptl_enable" : true, "ptl_c" : 0.05, "ptl_m" : 0.06, "ptl_y" : 0.05, "ptm_enable" : true, "ptm_low" : 0.8, "ptm_low_rng" : 0.5, "ptm_low_st" : 0.4, "ptm_high" : -0.8, "ptm_high_rng" : 0.3, "ptm_high_st" : 0.4, "brl_enable" : true, "brl" : 0.0, "brl_r" : -1.25, "brl_g" : -1.25, "brl_b" : -0.25, "brl_rng" : 0.3, "brl_st" : 0.5, "brlp_enable" : true, "brlp" : -0.5, "brlp_r" : -1.25, "brlp_g" : -1.25, "brlp_b" : 0.0, "hc_enable" : true, "hc_r" : 1.0, "hc_r_rng" : 0.4, "hs_rgb_enable" : true, "hs_r" : 0.5, "hs_r_rng" : 0.8, "hs_g" : 0.35, "hs_g_rng" : 1.0, "hs_b" : 0.5, "hs_b_rng" : 1.0, "hs_cmy_enable" : true, "hs_c" : 0.25, "hs_c_rng" : 1.0, "hs_m" : 0.0, "hs_m_rng" : 1.0, "hs_y" : 0.25, "hs_y_rng" : 1.0 }]
// 
// @ART-preset: ["look_aery", "Look - Aery", { "tn_con" : 1.15, "tn_sh" : 0.5, "tn_toe" : 0.04, "tn_off" : 0.006, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 0.0, "tn_hcon_st" : 0.5, "tn_lcon_enable" : true, "tn_lcon" : 0.5, "tn_lcon_w" : 2.0, "cwp" : 1, "cwp_lm" : 0.25, "rs_sa" : 0.25, "rs_rw" : 0.2, "rs_bw" : 0.5, "pt_enable" : true, "pt_lml" : 0.0, "pt_lml_r" : 0.35, "pt_lml_g" : 0.15, "pt_lml_b" : 0.1, "pt_lmh" : 0.0, "pt_lmh_r" : 0.5, "pt_lmh_b" : 0.0, "ptl_enable" : true, "ptl_c" : 0.05, "ptl_m" : 0.08, "ptl_y" : 0.05, "ptm_enable" : true, "ptm_low" : 0.8, "ptm_low_rng" : 0.35, "ptm_low_st" : 0.5, "ptm_high" : -0.9, "ptm_high_rng" : 0.5, "ptm_high_st" : 0.3, "brl_enable" : true, "brl" : -3.0, "brl_r" : 0.0, "brl_g" : 0.0, "brl_b" : 1.0, "brl_rng" : 0.8, "brl_st" : 0.15, "brlp_enable" : true, "brlp" : -1.0, "brlp_r" : -1.0, "brlp_g" : -1.0, "brlp_b" : 0.0, "hc_enable" : true, "hc_r" : 0.5, "hc_r_rng" : 0.25, "hs_rgb_enable" : true, "hs_r" : 0.6, "hs_r_rng" : 1.0, "hs_g" : 0.35, "hs_g_rng" : 2.0, "hs_b" : 0.5, "hs_b_rng" : 1.5, "hs_cmy_enable" : true, "hs_c" : 0.35, "hs_c_rng" : 1.0, "hs_m" : 0.25, "hs_m_rng" : 1.0, "hs_y" : 0.35, "hs_y_rng" : 0.5 }]
// 
// @ART-preset: ["look_dystopic", "Look - Dystopic", { "tn_con" : 1.6, "tn_sh" : 0.5, "tn_toe" : 0.01, "tn_off" : 0.008, "tn_hcon_enable" : true, "tn_hcon" : 0.25, "tn_hcon_pv" : 0.0, "tn_hcon_st" : 1.0, "tn_lcon_enable" : true, "tn_lcon" : 1.0, "tn_lcon_w" : 0.75, "cwp" : 2, "cwp_lm" : 0.25, "rs_sa" : 0.35, "rs_rw" : 0.25, "rs_bw" : 0.55, "pt_enable" : true, "pt_lml" : 0.0, "pt_lml_r" : 0.25, "pt_lml_g" : 0.0, "pt_lml_b" : 0.25, "pt_lmh" : 0.0, "pt_lmh_r" : 0.5, "pt_lmh_b" : 0.0, "ptl_enable" : true, "ptl_c" : 0.05, "ptl_m" : 0.08, "ptl_y" : 0.05, "ptm_enable" : true, "ptm_low" : 0.25, "ptm_low_rng" : 0.25, "ptm_low_st" : 0.8, "ptm_high" : -0.8, "ptm_high_rng" : 0.8, "ptm_high_st" : 0.25, "brl_enable" : true, "brl" : -2.0, "brl_r" : -3.0, "brl_g" : -2.0, "brl_b" : -2.0, "brl_rng" : 0.35, "brl_st" : 0.35, "brlp_enable" : true, "brlp" : 0.0, "brlp_r" : -1.0, "brlp_g" : -1.0, "brlp_b" : -1.0, "hc_enable" : true, "hc_r" : 1.0, "hc_r_rng" : 0.25, "hs_rgb_enable" : true, "hs_r" : 0.7, "hs_r_rng" : 1.33, "hs_g" : 1.0, "hs_g_rng" : 2.0, "hs_b" : 0.75, "hs_b_rng" : 2.0, "hs_cmy_enable" : true, "hs_c" : 1.0, "hs_c_rng" : 0.5, "hs_m" : 1.0, "hs_m_rng" : 1.0, "hs_y" : 1.0, "hs_y_rng" : 0.77 }]
// 
// @ART-preset: ["look_umbra", "Look - Umbra", { "tn_con" : 1.8, "tn_sh" : 0.5, "tn_toe" : 0.001, "tn_off" : 0.015, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 1.0, "tn_lcon_w" : 1.0, "cwp" : 5, "cwp_lm" : 0.25, "rs_sa" : 0.35, "rs_rw" : 0.25, "rs_bw" : 0.55, "pt_enable" : true, "pt_lml" : 0.0, "pt_lml_r" : 0.5, "pt_lml_g" : 0.0, "pt_lml_b" : 0.15, "pt_lmh" : 0.25, "pt_lmh_r" : 0.25, "pt_lmh_b" : 0.0, "ptl_enable" : true, "ptl_c" : 0.05, "ptl_m" : 0.06, "ptl_y" : 0.05, "ptm_enable" : true, "ptm_low" : 0.4, "ptm_low_rng" : 0.35, "ptm_low_st" : 0.66, "ptm_high" : -0.5, "ptm_high_rng" : 0.5, "ptm_high_st" : 0.35, "brl_enable" : true, "brl" : -2.0, "brl_r" : -4.5, "brl_g" : -3.0, "brl_b" : -4.0, "brl_rng" : 0.35, "brl_st" : 0.3, "brlp_enable" : true, "brlp" : 0.0, "brlp_r" : -2.0, "brlp_g" : -1.0, "brlp_b" : -0.5, "hc_enable" : true, "hc_r" : 1.0, "hc_r_rng" : 0.35, "hs_rgb_enable" : true, "hs_r" : 0.66, "hs_r_rng" : 1.0, "hs_g" : 0.5, "hs_g_rng" : 2.0, "hs_b" : 0.85, "hs_b_rng" : 2.0, "hs_cmy_enable" : true, "hs_c" : 0.0, "hs_c_rng" : 1.0, "hs_m" : 0.25, "hs_m_rng" : 1.0, "hs_y" : 0.66, "hs_y_rng" : 0.66 }]
// 
// @ART-preset: ["look_base", "Look - Base", { "tn_con" : 1.66, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.005, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : false, "tn_lcon" : 0.0, "tn_lcon_w" : 0.5, "cwp" : 2, "cwp_lm" : 0.25, "rs_sa" : 0.35, "rs_rw" : 0.25, "rs_bw" : 0.55, "pt_enable" : true, "pt_lml" : 0.5, "pt_lml_r" : 0.5, "pt_lml_g" : 0.15, "pt_lml_b" : 0.15, "pt_lmh" : 0.8, "pt_lmh_r" : 0.5, "pt_lmh_b" : 0.0, "ptl_enable" : true, "ptl_c" : 0.05, "ptl_m" : 0.06, "ptl_y" : 0.05, "ptm_enable" : false, "ptm_low" : 0.0, "ptm_low_rng" : 0.5, "ptm_low_st" : 0.5, "ptm_high" : 0.0, "ptm_high_rng" : 0.5, "ptm_high_st" : 0.5, "brl_enable" : false, "brl" : 0.0, "brl_r" : 0.0, "brl_g" : 0.0, "brl_b" : 0.0, "brl_rng" : 0.5, "brl_st" : 0.35, "brlp_enable" : true, "brlp" : -0.5, "brlp_r" : -1.6, "brlp_g" : -1.6, "brlp_b" : -0.8, "hc_enable" : false, "hc_r" : 0.0, "hc_r_rng" : 0.25, "hs_rgb_enable" : false, "hs_r" : 0.0, "hs_r_rng" : 1.0, "hs_g" : 0.0, "hs_g_rng" : 1.0, "hs_b" : 0.0, "hs_b_rng" : 1.0, "hs_cmy_enable" : false, "hs_c" : 0.0, "hs_c_rng" : 1.0, "hs_m" : 0.0, "hs_m_rng" : 1.0, "hs_y" : 0.0, "hs_y_rng" : 1.0 }]
//
// @ART-preset: ["tonescale_low_contrast", "Tonescale - Low Contrast", { "tn_con" : 1.4, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.005, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : false, "tn_lcon" : 0.0, "tn_lcon_w" : 0.5 }]
//
// @ART-preset: ["tonescale_medium_contrast", "Tonescale - Medium Contrast", { "tn_con" : 1.66, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.005, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : false, "tn_lcon" : 0.0, "tn_lcon_w" : 0.5 }]
//
// @ART-preset: ["tonescale_high_contrast", "Tonescale - High Contrast", { "tn_con" : 1.4, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.005, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 1.0, "tn_lcon_w" : 0.5 }]
//
// @ART-preset: ["tonescale_arriba", "Tonescale - Arriba", { "tn_con" : 1.05, "tn_sh" : 0.5, "tn_toe" : 0.1, "tn_off" : 0.01, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 1.5, "tn_lcon_w" : 0.2 }]
//
// @ART-preset: ["tonescale_sylvan", "Tonescale - Sylvan", { "tn_con" : 1.6, "tn_sh" : 0.5, "tn_toe" : 0.01, "tn_off" : 0.01, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 0.25, "tn_lcon_w" : 0.75 }]
//
// @ART-preset: ["tonescale_colorful", "Tonescale - Colorful", { "tn_con" : 1.5, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.003, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 0.4, "tn_lcon_w" : 0.5 }]
//
// @ART-preset: ["tonescale_aery", "Tonescale - Aery", { "tn_con" : 1.15, "tn_sh" : 0.5, "tn_toe" : 0.04, "tn_off" : 0.006, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 0.0, "tn_hcon_st" : 0.5, "tn_lcon_enable" : true, "tn_lcon" : 0.5, "tn_lcon_w" : 2.0 }]
//
// @ART-preset: ["tonescale_dystopic", "Tonescale - Dystopic", { "tn_con" : 1.6, "tn_sh" : 0.5, "tn_toe" : 0.01, "tn_off" : 0.008, "tn_hcon_enable" : true, "tn_hcon" : 0.25, "tn_hcon_pv" : 0.0, "tn_hcon_st" : 1.0, "tn_lcon_enable" : true, "tn_lcon" : 1.0, "tn_lcon_w" : 0.75 }]
//
// @ART-preset: ["tonescale_umbra", "Tonescale - Umbra", { "tn_con" : 1.8, "tn_sh" : 0.5, "tn_toe" : 0.001, "tn_off" : 0.015, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 1.0, "tn_lcon_w" : 1.0 }]
//
// @ART-preset: ["tonescale_aces1", "Tonescale - ACES-1.x", { "tn_con" : 1.0, "tn_sh" : 0.35, "tn_toe" : 0.02, "tn_off" : 0.0, "tn_hcon_enable" : true, "tn_hcon" : 0.55, "tn_hcon_pv" : 0.0, "tn_hcon_st" : 2.0, "tn_lcon_enable" : true, "tn_lcon" : 1.13, "tn_lcon_w" : 1.0 }]
//
// @ART-preset: ["tonescale_aces2", "Tonescale - ACES-2.0", { "tn_con" : 1.15, "tn_sh" : 0.5, "tn_toe" : 0.04, "tn_off" : 0.0, "tn_hcon_enable" : false, "tn_hcon" : 1.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 1.0, "tn_lcon_enable" : false, "tn_lcon" : 1.0, "tn_lcon_w" : 0.6 }]
//
// @ART-preset: ["tonescale_marvelous", "Tonescale - Marvelous Tonescape", { "tn_con" : 1.5, "tn_sh" : 0.5, "tn_toe" : 0.003, "tn_off" : 0.01, "tn_hcon_enable" : true, "tn_hcon" : 0.25, "tn_hcon_pv" : 0.0, "tn_hcon_st" : 4.0, "tn_lcon_enable" : true, "tn_lcon" : 1.0, "tn_lcon_w" : 1.0 }]
//
// @ART-preset: ["tonescale_dagrinchi", "Tonescale - DaGrinchi Tonegroan", { "tn_con" : 1.2, "tn_sh" : 0.5, "tn_toe" : 0.02, "tn_off" : 0.0, "tn_hcon_enable" : false, "tn_hcon" : 0.0, "tn_hcon_pv" : 1.0, "tn_hcon_st" : 1.0, "tn_lcon_enable" : false, "tn_lcon" : 0.0, "tn_lcon_w" : 0.6 }]
